---
title: "Fish Community Rehabilitation"
collection: projects
---
...
<div style="display: flex; align-items: stretch; gap: 2rem;">
  ...
  <div style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
    <img src="/images/SanfordPreulStimetzTracking2022.jpg" alt="" style="width: 100%; height: 100%; object-fit: cover;">
    <figcaption style="text-align: center; font-size: 0.9em; margin-top: 0.5rem;">Radio telemetry to monitor fish responses to habitat modification.</figcaption>
  </div>
</div>
